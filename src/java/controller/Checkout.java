...
//                    System.out.println("Calling Save Order");
                }
    ...
    private void saveOrders(Session session, Transaction transaction, User user, Address address, JsonObject responseJsonObject) {
        try {
            ...
            String merchant_id = "1221214";
            String formatted_amount = new DecimalFormat("0.00").format(amount);
            String currency = "LKR";
            String merchantSecret = "NDEzMjQwMTQ0MDE4MzQ2NjgyMzMzMDYwNTc5NzIxNDM0NjU3NzQy"; //**
            ...
            payhere.addProperty("notify_url", "https://3710-116-206-246-186.ngrok-free.app/SwiftRoll/VerifyPayment"); //***
            ...
            payhere.addProperty("phone", "0781048585");
            payhere.addProperty("address", "811/2, Dharmapala Mawatha, Narangodapaluwa,");
            payhere.addProperty("city", "Ragama");
            ...
            System.out.println(formatted_amount);
