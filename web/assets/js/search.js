...
function updateProductView(json) {
    ...
    json.productList.forEach(product => {
        ...
        //update cards
        st_product_clone.querySelector("#st-product-a-1").href = "product.html?pid=" + product.id;
        st_product_clone.querySelector("#st-product-img-1").src = "product_images/" + product.id + "/image1.png";
        st_product_clone.querySelector("#st-product-a-2").href = "product.html?pid=" + product.id;
